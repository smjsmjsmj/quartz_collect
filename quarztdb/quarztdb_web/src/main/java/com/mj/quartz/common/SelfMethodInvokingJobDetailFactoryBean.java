 ...
 * @see #setConcurrent
 */
public class SelfMethodInvokingJobDetailFactoryBean extends ArgumentConvertingMethodInvoker
		implements FactoryBean<JobDetail>,Serializable, BeanNameAware, BeanClassLoaderAware, BeanFactoryAware, InitializingBean {
	 ...
	 */
	public static class MethodInvokingJob extends QuartzJobBean implements Serializable {
